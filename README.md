...
- 4. Exploratory_Data_Analysis/: EDA notebooks and analysis notes.
...
- 7. Predictive_Analytics/: Predictive modeling exercises and supporting notes.
...
- 10. Advanced Data Science/: Advanced data science coursework artifacts.

Each directory includes a local [README.md](http://_vscodecontentref_/0) that covers the technical scope, file inventory, and tooling notes.
...
| 7. Predictive_Analytics/ | Predictive modeling exercises | Model evaluation notebooks |
...
| 10. Advanced Data Science/ | Advanced methods and synthesis | Advanced coursework artifacts |
...
1. Start at the folder-level [README.md](http://_vscodecontentref_/1) to understand the scope and key files.
